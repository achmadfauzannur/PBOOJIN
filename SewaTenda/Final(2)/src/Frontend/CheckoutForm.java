...
public class CheckoutForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Metode tersimpan");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jLabel4.setText("Nama CC");

        jLabel5.setText("CC Number");

        jLabel6.setText("Expired");

        jLabel7.setText("CVV");

        jButton1.setText("Tambahkan metode");

        jLabel8.setText("Metode Name");

        jButton2.setText("Edit metode");

        jButton3.setText("Hapus metode ");

        jButton4.setText("Checkout");

        jLabel9.setText("Total charge");

        jLabel10.setText("LabelTotal");
